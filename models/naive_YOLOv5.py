...
# Here we train the model using the YOLOv5s architecture
# The key difference is that we freeze 24 layers of the model to see how it compares to training the entire model
